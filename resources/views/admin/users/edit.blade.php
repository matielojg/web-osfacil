    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            <div class="nav">
                ...
                {{-- condição para funcionario ou técnico nao editar usuario diferente deles--}}
                @if(( auth()->user()->id != $user->id ) and ((auth()->user()->function == 'funcionario') xor auth()->user()->function == 'tecnico'))
                    <h1>{{auth()->user()->first_name}}, a edição deste usuário não é permitida!<br>
                        Este incidente será reportado.</h1>
                @else
                    <form class="app_form" action=" {{ route('admin.users.update', ['user' =>$user->id]) }} "
                            ...
                            <div class="label_g2">
                                ...
                                <label class="label">
                                    ...
                                    <select name="function" class="form-control" required="ON">
                                        ...
                                        <option
                                            value="1" {{ (old('function') == '1' ? 'selected' : ( $user->function == '1' ? 'selected' : '')) }}>
                                            Funcionário
                                        </option>
                                        <option
                        ...
                        <div class="text-right mt-2">
                            <a href="{{ route('admin.users.index')  }}" class="btn btn-large btn-yellow icon-arrow-left" type="submit">Cancelar
                            </a>
                            <button
